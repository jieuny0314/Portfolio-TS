...
import { FaAngleLeft, FaAngleRight, FaRegHandPaper } from "react-icons/fa";
...
const ProjectDetailContainer = styled.section<StyledType>`
  display: flex;
...
const PreviewImg = styled.div<ImgType>`
  width: 100%;
  height: 100%;
  position: relative;
  flex-shrink: 0;
      ...
      <Background $ismobile={isMobile}>
        <ProjectDetailContainer $ismobile={isMobile}>
          ...
          <article className="roleBox">
            <div className="flex">
              <FaRegHandPaper className="icon" size="24" color="#eecb9a" />
